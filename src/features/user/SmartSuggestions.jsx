  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="flex items-center justify-between">
        <h2 className="text-xl font-bold text-theme-primary">智能学习建议</h2>
      ...
      {suggestions.length === 0 ? (
        <Card padding="p-8" className="text-center">
          ...
          <p className="text-sm text-theme-muted">目前学习状态良好，没有特别建议</p>
          <p className="text-xs text-theme-muted mt-1">继续保持，挑战更高难度吧！</p>
        </Card>
      ) : (
      ...
      {/* Profile summary */}
      <Card padding="p-4">
        <h3 className="font-semibold text-theme-primary text-sm mb-3">你的学习画像</h3>
        <div className="grid grid-cols-2 gap-2">
          {[
            ...
            <div key={item.label} className="bg-theme-elevated rounded-xl p-2.5">
              <div className="text-[10px] text-theme-muted">{item.label}</div>
              <div className="text-sm font-medium text-theme-secondary">{item.value}</div>
            </div>
          ))}
        </div>
