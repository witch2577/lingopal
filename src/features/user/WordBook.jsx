                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2">
                        <span className="font-semibold text-theme-primary">{w.word}</span>
                        <Badge variant="primary" className="text-[10px]">
                          {LANGUAGE_MAP[w.language]?.name || w.language}
                        </Badge>
                      </div>
                      <div className="text-sm text-theme-muted mt-1">{w.translation}</div>
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      <button
                        ...
                        className="p-1.5 rounded-lg text-theme-disabled hover:text-red-500 hover:bg-red-50 transition-colors"
                      >
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="text-sm">
                        ...
                        <span className="text-theme-disabled mx-2">→</span>
