...
// Merge business typing data if available
if (typeof BUSINESS_SPELLING_WORDS !== 'undefined') {
  Object.keys(BUSINESS_SPELLING_WORDS).forEach(lang => {
    if (SPELLING_WORDS[lang] && BUSINESS_SPELLING_WORDS[lang].business) {
      SPELLING_WORDS[lang].business = BUSINESS_SPELLING_WORDS[lang].business;
    }
  });
}
